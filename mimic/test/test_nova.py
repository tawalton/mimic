...
class NovaAPITests(SynchronousTestCase):
    ...
    def setUp(self):
        ...
        self.create_server_response, self.create_server_response_body = (
            create_server(self.helper, imageRef='c25f1ae0-30b3-4012-8ca6-5ecfcf05c965', name=self.server_name))
    ...
    def test_create_image(self):
        ...
        create_image = request(
            self, self.root, "POST",
            self.uri + '/servers/' + self.server_id + '/action', create_request)
        create_image_response = self.successResultOf(create_image)
        self.assertEqual(create_image_response.code, 200)
